...
describe SolrDocument do
  ...
  let!(:file_set) { FactoryBot.create(:file_set, user: FactoryBot.create(:user)) }
  ...
  describe "associated preservation message digest events", :clean_fedora do
    ...
    let!(:current_mes) { FactoryBot.create(:preservation_event, premis_event_related_object: file_set, premis_event_type: premis_event_type, premis_event_date_time: [ DateTime.parse('2016-02-01T04:05:06+07:00') ], premis_event_outcome: [ '63ab6f1c03a33f2b4c2148eb6bb8c425' ] ) }

    let!(:previous_mes) { FactoryBot.create(:preservation_event, premis_event_related_object: file_set, premis_event_type: premis_event_type, premis_event_date_time: [ DateTime.parse('2015-02-01T04:05:06+07:00') ], premis_event_outcome: [ '63ab6f1c03a33f2b4c2148eb6bb8c425' ] ) }
    ...
    context 'with an unclean(!) current message digest event' do
      let!(:dirty_mes) { FactoryBot.create(:preservation_event, premis_event_related_object: file_set, premis_event_type: premis_event_type, premis_event_date_time: [ DateTime.parse('2017-02-01T04:05:06+07:00') ], premis_event_outcome: [ '885ed0fb6cf8e55cac6f5b548730f879' ] ) }
